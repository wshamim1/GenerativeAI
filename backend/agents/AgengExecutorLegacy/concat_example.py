...
from backend.agents.tools.concat_tool import ConcatToolWrapper  # Ensure this is correctly implemented
...
async def main():
    tool_classes = [ConcatToolWrapper]  # ✅ Ensure only valid tools are used
    chat_history = []
    ...
    input_data = {"items": ["aaaa", "bbbb"]}  # ✅ Corrected input format
